...
//
const BotName = 'WHYY-BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/whyy14_'; // Nama Instagramlu cok
const whatsapplu = '0822-8213-0708'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/E7EJg8BUsXIEtcOkMGo3yM'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/E7EJg8BUsXIEtcOkMGo3yM'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
